...
const summary: DashboardSummary = {
  ...
  upcomingSpend: 285000,
  availableCash: 557000,
  forecastMonthEndBalance: 342000,
  budgetUsage: 64,
  plannedExpensesThisMonth: 425000
};
...
const kpiCards: KpiCard[] = [
  {
    ...
    description: `계좌 잔액 ${formatWon(summary.currentBalance)} - 예정 지출 ${formatWon(summary.upcomingSpend)}`,
    icon: Wallet,
    tone: "highlight"
  },
  {
  ...
  },
  {
    ...
    description: "이번 달 설정 예산 대비 현재까지 사용한 비율",
    icon: BadgePercent,
    tone: "default"
  },
  {
    ...
    description: "고정비와 준고정비를 합친 이번 달 예상 출금액",
    icon: CalendarRange,
    tone: "default"
  }
];
      ...
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
            계좌 잔액과 예정 지출을 바탕으로, 지금 실제로 쓸 수 있는 돈을 먼저 보여줍니다.
          </p>
        </div>
